...
from ..core.config import GAME_HEIGHT, GAME_WIDTH, MIN_TERMINAL_HEIGHT, MIN_TERMINAL_WIDTH
from ..core.sprites import BorderChars
...
class Display:
    ...
    def __init__(self) -> None:
        ...
        self.buffer: list[list[str]] = [[' ' for _ in range(GAME_WIDTH)] for _ in range(GAME_HEIGHT)]
    ...
    def set_char(self, x: int, y: int, char: str, color: str = Colors.WHITE) -> None:
    ...
    def set_string(self, x: int, y: int, text: str, color: str = Colors.WHITE) -> None:
    ...
    def draw_centered_text(self, y: int, text: str, color: str = Colors.WHITE) -> None:
...
class MockDisplay(Display):
    ...
    def __init__(self) -> None:
        self.terminal_width: int = GAME_WIDTH
        self.terminal_height: int = GAME_HEIGHT
        self.offset_x: int = 0
        self.offset_y: int = 0
        self.buffer: list[list[str]] = [[' ' for _ in range(GAME_WIDTH)] for _ in range(GAME_HEIGHT)]
        self.rendered_frames: list[list[str]] = []
